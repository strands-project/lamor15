...
tmux new-window -t $SESSION:4 -n 'ppl_emulator'
tmux new-window -t $SESSION:5 -n 'qsr_lib'
...
tmux send-keys "DISPLAY=:0 roslaunch lamor_bringup lamor_sim_navigation.launch"
